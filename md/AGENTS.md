...
this directory. The seat is a durable authority boundary; the Codex session ID,
running client, model, reasoning effort, and tmux process are replaceable runtime
properties. Read [Rig's operating architecture](../ARCHITECTURE.md).
...
display name, stable slug, durable home, isolated worktree, runtime, Codex
session-history association, Beads actor, and notification readiness. Read
