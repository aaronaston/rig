...
Status: MD launcher implemented; Nadia is ready as the first fleet member. [Scope and naming](../decisions/initial-scope.md) reflect the latest user direction.
...
MD sessions use Sol/high for requirements and validation. Fleet sessions inherit
Luna/high for bounded implementation. Both launch with workspace-write and
